...
yara is **cava** — the cross-platform audio visualizer — renamed and rebuilt for Windows. This repository is a pristine copy of [karlstav/cava](https://github.com/karlstav/cava) (the whole SDL/GLSL visualizer, WASAPI capture, shaders and all), renamed to **yara**. The full upstream documentation below applies to yara; on Windows the program builds with vcpkg + MinGW and captures your audio with WASAPI.
